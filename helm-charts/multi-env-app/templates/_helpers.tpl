...
helm.sh/chart: {{ include "multi-env-app.chart" . }}
...
*/}}
{{- define "multi-env-app.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "multi-env-app.fullname" .) .Values.serviceAccount.name }}
{{- else }}
